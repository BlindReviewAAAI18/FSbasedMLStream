...
//	                	System.out.println(tempString);
	 ...
	 /**
	    ...
	    public static void readFileByLines(String fileName) {
	        ...
	        BufferedReader reader = null;
	        try {
	            System.out.println("read by lines£º");
...
//		}
	...
	// cmd: -path F:\EÅÌ\Jesse-Read-Multi-labels\IMDB-ECC-F -train IMDB-ECC-F-train.arff -test IMDB-ECC-F-test.arff -output RDTTest.txt -attrSize 1029 -labelNum 28
